...
def do_temp_dp_2021(raw_temp_dp_data:numpy.array((2,HOURS_PER_YEAR),dtype=numpy.float32), lon):
...
def do_wind_2021(raw_wind_data:numpy.array((2,HOURS_PER_YEAR),dtype=numpy.float32)):
...
def do_precip_2021(raw_precip_data:numpy.array((2,HOURS_PER_YEAR),dtype=numpy.float32)):
...
def do_cloud_cover_2021(raw_cloud_cover_data):
