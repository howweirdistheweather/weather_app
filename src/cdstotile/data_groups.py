...
all_variables = [CDSVAR_U10, CDSVAR_V10, CDSVAR_D2M, CDSVAR_T2M, CDSVAR_CBH, CDSVAR_PTYPE, CDSVAR_TCC, CDSVAR_TP, CDSVAR_RO, CDSVAR_PEV, CDSVAR_HMAX, CDSVAR_SWH, CDSVAR_PP1D, CDSVAR_SST]
...
data_groups = {
    ...
    'drought':{'files':[CDSVAR_PEV], 'analyze': do_drought, 'sub_vars':['drought']},
